  ...
  ThemeData appBarTheme(BuildContext context) {
    return Theme.of(context).copyWith(
      ...
      scaffoldBackgroundColor: const Color.fromARGB(
          255, 233, 255, 255), // Background color of search page
      inputDecorationTheme: InputDecorationTheme(
        fillColor: const Color.fromARGB(
            10, 0, 0, 0), // Background color of the search box
        filled: true,
        hintStyle: const TextStyle(
            color: Color.fromARGB(255, 172, 172, 172),
            fontSize: 18.0), // Text color of search box hint
              ...
              if (searchProvider.selectedOrganization == 'Doctor')
                Expanded(
                  child: buildFilterBox(
                      context, 'Specialization', specializations),
                ),
              if (searchProvider.selectedOrganization == 'Lab' ||
                  searchProvider.selectedOrganization == 'Doctor')
                const SizedBox(width: 5.0),
              if (searchProvider.selectedOrganization == 'Lab' ||
                  searchProvider.selectedOrganization == 'Doctor')
                Expanded(
